document.addEventListener("DOMContentLoaded", function() {
    const checkboxes = [
        document.getElementById("internshipCheck"),
        document.getElementById("pabauCheck"),
        document.getElementById("employmentCheck"),
        document.getElementById("careerCheck")
    ];
    ...
    function generateRandomValue() {
        const randomWords = ["React", "TypeScript", "JavaScript", "VueJs"];
